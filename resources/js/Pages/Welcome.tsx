                        ...
                        <div className="grid w-full grid-cols-1 items-center gap-16 py-12 lg:grid-cols-2">
                            ...
                            <div className="space-y-8">
                                ...
                                <p className="max-w-xl text-lg leading-relaxed text-gray-600 dark:text-gray-400">
                                    A unified workspace for your Impact Cell,
                                    Follow-Up Officers, and Follow-Up Teams —
                                    built so no guest falls through the cracks
                                    and every hand-off is accountable.
                                </p>
                            ...
                            <div className="relative">
                                <div className="relative grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    {[
                                        {
                                            title: 'Guest records',
                                            body: 'One source of truth per guest across visit history, contact attempts, and follow-up status.',
                                            icon: (
                                        ...
                                        },
                                        {
                                            ...
                                            body: 'Configurable contact-attempt windows, escalations, and not-reachable queues.',
                                            icon: (
                                        ...
                                        {
                                            title: 'Impact cells',
                                            body: 'Hierarchical cell model with primary cells and sub-cells — soft-deletes with safety rails.',
                                            icon: (
                                        ...
                                        {
                                            title: 'Insight & audit',
                                            body: 'Daily KPIs, leadership board, and an immutable activity log for every write.',
                                            icon: (
